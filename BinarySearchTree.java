 ...
 */
public class BinarySearchTree <E extends Comparable<? super E>> implements DataCounter<String> {
     ...
     */
    protected int traverse(BSTNode root, DataCount<String>[] counts, int idx) {
        if(root != null) {
            idx = traverse(root.left, counts, idx);
            counts[idx] = new DataCount<String>(root.data, root.count);
